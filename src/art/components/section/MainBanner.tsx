          ...
          >
            ...
            <div
              style={{
                ...
                // 💡 좌우는 더 슬림하게(50~60%), 상하는 더 묵직하게(패딩 50% 추가)
                width: isMobile ? "65%" : "50%",
                padding: isMobile ? "80px 20px" : "110px 40px",
                ...
                zIndex: 2,
                boxShadow: "0 30px 60px rgba(0,0,0,0.3)", // 💡 입체감 강조
              }}
            >
              <h1
                style={{
