/**
 * 14장 · 데이터 레이어 커스텀 훅 — 목록/상세 로드·저장·삭제를 한곳에 모음.
 *
...
export function useArtwork() {
  ...
  // 14장: 편집 초기값 — 상세 + 이미지 목록(실제 폼 연동 시 사용)
  ...
  // 14장: 생성/수정 공통 — payload 가공 후 POST 또는 PUT
